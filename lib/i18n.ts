export const locales = {
  id: {
    viewer: {
      ...
      walkHint: 'Klik untuk masuk — WASD gerak, mouse lihat, Esc keluar',
      commentHint: 'Klik pada model untuk menaruh komentar',
    },
    tree: {
    ...
    comments: {
      ...
      author: 'Nama (opsional)',
      save: 'Simpan',
      cancel: 'Batal',
      empty: 'Belum ada komentar. Aktifkan tool Komentar lalu klik model.',
      delete: 'Hapus',
  ...
  en: {
    viewer: {
      ...
      walkHint: 'Click to enter — WASD to move, mouse to look, Esc to exit',
      commentHint: 'Click on the model to drop a comment',
    },
    tree: {
    ...
    comments: {
      ...
      save: 'Save',
      cancel: 'Cancel',
      empty: 'No comments yet. Enable the Comment tool then click the model.',
      delete: 'Delete',
