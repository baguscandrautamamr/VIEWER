export const locales = {
  id: {
    viewer: {
      ...
      bgWhite: 'Putih',
      bgDark: 'Gelap',
      autoFocusOn: 'Auto-fokus menyala — kamera mendekat ke objek yang diklik. Klik untuk mematikan.',
      autoFocusOff: 'Auto-fokus mati — klik objek tidak menggerakkan kamera. Klik untuk menyalakan.',
      color: 'Warna',
      colorReset: 'Kembalikan warna asli',
      hideObject: 'Sembunyikan objek',
      hideObjectNotice:
  ...
  en: {
    viewer: {
      ...
      bgWhite: 'White',
      bgDark: 'Dark',
      autoFocusOn: 'Auto-focus on — the camera moves in on the object you click. Click to turn off.',
      autoFocusOff: 'Auto-focus off — clicking an object leaves the camera still. Click to turn on.',
      color: 'Color',
